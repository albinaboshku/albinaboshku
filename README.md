...
<!-- Cover Image and Totoro GIFs Container -->
<div style="position: relative;">
  <!-- Your Cover Image -->
<img src="https://github.com/albinaboshku/albinaboshku/blob/main/images/Studio%20Ghibli_%20Photo.gif" alt="Cover Image" width="100%" style="position: absolute; z-index: -1;">

  <!--   <img src="https://github.com/albinaboshku/albinaboshku/blob/main/images/d5o2bsr-1336ebb8-1235-415d-b7ed-225f1b544e82.gif" alt="Totoro 1" width="50" style="position: absolute; top: 50%; transform: translateY(-50%); animation: totoro1 5s linear infinite;"> -->

 <!-- <img src="https://github.com/albinaboshku/albinaboshku/blob/main/images/output-onlinegiftools.gif" alt="Totoro 2" width="100" style="position: absolute; top: 70%; transform: translateY(-50%); animation: totoro2 5s linear infinite;"> -->
</div>
